...
<div class="text-right mb-2">
    <a href="fpdf/ReporteEmpleado.php" target="_blank" class="btn btn-success"><i class="fa-regular fa-file"></i>Generar reportes</a>
</div>
...
<thead>
    ...
    while ($datos=$sql->fetch_object()) {?>
            ...
            <td><?= $datos->dni?></td>
            <td>
                <a href="" data-toggle="modal" data-target="#exampleModal<?=$datos->id_empleado?>"class="btn btn-warning btm-sm"><i class="fa-solid fa-file-pen"></i></a>
                <a href="empleado.php?id=<?=$datos->id_empleado?>" onclick="advertencia(event)" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
        </td>
            </tr>

...
<div class="text-right mb-2">
    <a href="fpdf/ReporteUsuario.php" target="_blank" class="btn btn-success"><i class="fa-regular fa-file"></i>Generar reportes</a>
</div>
...
<thead>
    ...
    while ($datos=$sql->fetch_object()) {?>
            ...
            <td><?= $datos->usuario?></td>
            <td>
                <a href="" data-toggle="modal" data-target="#exampleModal<?=$datos->id_usuario?>"class="btn btn-warning btm-sm"><i class="fa-solid fa-file-pen"></i></a>
                <a href="usuario.php?id=<?=$datos->id_usuario?>" onclick="advertencia(event)" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
        </td>
            </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="" method="POST">
        ...
        <div class="fl-flex-label mb-4 px-2 col-12">
            <input type="password" placeholder="password" class="input input__text" name="txtpassword" value="<?=$datos->password?>">
        </div>

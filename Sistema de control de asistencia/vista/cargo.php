...
$sql=$conexion->query(" SELECT * from cargo")
   ...
   ?>
<a href="Registro_cargos.php"class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-plus"></i> &nbsp;Registrar</a>
...
<thead>
    ...
    while ($datos=$sql->fetch_object()) {?>
            ...
            <td><?= $datos->nombre?></td>
            <td>
                <a href="" data-toggle="modal" data-target="#exampleModal<?=$datos->id_cargo?>"class="btn btn-warning btm-sm"><i class="fa-solid fa-file-pen"></i></a>

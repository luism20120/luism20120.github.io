...
while ($datos_reporte = $consulta_reporte_asistencia->fetch_object()) {
   ...
   $cargoDecodificado = ($datos_reporte->nomCargo !== null) ? utf8_decode($datos_reporte->nomCargo) : '';
   $pdf->Cell(50, 10, $cargoDecodificado, 1, 0, 'C', 0);
   ...
   $pdf->Cell(50, 10, $salidaDecodificada, 1, 1, 'C', 0);
}
